...
class HomeworksControllerTest < ActionController::TestCase
  ...
  test "should create homework" do
    assert_difference('Homework.count') do
      post :create, homework: { class_id: @homework.class_id, description: @homework.description, game_id: @homework.game_id, title: @homework.title }
    end
  ...
  test "should update homework" do
    patch :update, id: @homework, homework: { class_id: @homework.class_id, description: @homework.description, game_id: @homework.game_id, title: @homework.title }
    assert_redirected_to homework_path(assigns(:homework))
  end
